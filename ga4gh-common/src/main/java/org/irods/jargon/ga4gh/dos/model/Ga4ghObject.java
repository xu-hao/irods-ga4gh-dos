...
public class Ga4ghObject   {
  ...
  **/
  ...
  /**
   * A string that can be used to name an `Ga4ghObject`. This string is made up of uppercase and lowercase letters, decimal digits, hypen, period, and underscore [A-Za-z0-9.-_]. See http://pubs.opengroup.org/onlinepubs/9699919799/basedefs/V1_chap03.html#tag_03_282[portable filenames].
   * @return name
  **/
...
@Size(min=1) 
  ...
  /**
   * The list of access methods that can be used to fetch the `Ga4ghObject`. Required for single blobs; optional for bundles.
...
@Size(min=1) 
  ...
  /**
   * If not set, this `Ga4ghObject` is a single blob. If set, this `Ga4ghObject` is a bundle containing the listed `ContentsObject` s (some of which may be further nested).
   * @return contents
  **/
  ...
  **/
  ...
  /**
   * A list of strings that can be used to find other metadata about this `Ga4ghObject` from external metadata sources. These aliases can be used to represent secondary accession numbers or external GUIDs.
   * @return aliases
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, object.id) &&
        ...
        Objects.equals(this.selfUri, object.selfUri) &&
        Objects.equals(this.size, object.size) &&
        Objects.equals(this.createdTime, object.createdTime) &&
        Objects.equals(this.updatedTime, object.updatedTime) &&
        Objects.equals(this.version, object.version) &&
        Objects.equals(this.mimeType, object.mimeType) &&
        Objects.equals(this.checksums, object.checksums) &&
