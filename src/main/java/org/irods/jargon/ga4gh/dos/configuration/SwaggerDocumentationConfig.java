...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("iRODS GA4GH DOS").description("iRODS GA4GH Data Object Service")
				.license("BSD 3 Clause").licenseUrl("http://unlicense.org").termsOfServiceUrl("").version("1.0.0")
				.contact(new Contact("Michael Conway", "", "mike.conway@nih.gov")).build();
	}
