...
public class Ga4ghApiController implements Ga4ghApi {
    ...
    public ResponseEntity<Ga4ghCreateDataBundleResponse> createDataBundle(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Ga4ghCreateDataBundleRequest body) {
        // do some magic!
        return new ResponseEntity<Ga4ghCreateDataBundleResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghCreateDataObjectResponse> createDataObject(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Ga4ghCreateDataObjectRequest body) {
        // do some magic!
        return new ResponseEntity<Ga4ghCreateDataObjectResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghDeleteDataBundleResponse> deleteDataBundle(@ApiParam(value = "",required=true ) @PathVariable("data_bundle_id") String dataBundleId) {
        // do some magic!
        return new ResponseEntity<Ga4ghDeleteDataBundleResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghDeleteDataObjectResponse> deleteDataObject(@ApiParam(value = "",required=true ) @PathVariable("data_object_id") String dataObjectId) {
        // do some magic!
        return new ResponseEntity<Ga4ghDeleteDataObjectResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghGetDataBundleResponse> getDataBundle(@ApiParam(value = "",required=true ) @PathVariable("data_bundle_id") String dataBundleId,
    ...
    public ResponseEntity<Ga4ghGetDataBundleVersionsResponse> getDataBundleVersions(@ApiParam(value = "",required=true ) @PathVariable("data_bundle_id") String dataBundleId) {
        // do some magic!
        return new ResponseEntity<Ga4ghGetDataBundleVersionsResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghGetDataObjectResponse> getDataObject(@ApiParam(value = "",required=true ) @PathVariable("data_object_id") String dataObjectId,
    ...
    public ResponseEntity<Ga4ghGetDataObjectVersionsResponse> getDataObjectVersions(@ApiParam(value = "",required=true ) @PathVariable("data_object_id") String dataObjectId) {
        // do some magic!
        return new ResponseEntity<Ga4ghGetDataObjectVersionsResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghListDataBundlesResponse> listDataBundles(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Ga4ghListDataBundlesRequest body) {
        // do some magic!
        return new ResponseEntity<Ga4ghListDataBundlesResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghListDataObjectsResponse> listDataObjects(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Ga4ghListDataObjectsRequest body) {
        // do some magic!
        return new ResponseEntity<Ga4ghListDataObjectsResponse>(HttpStatus.OK);
    }

    public ResponseEntity<Ga4ghUpdateDataBundleResponse> updateDataBundle(@ApiParam(value = "",required=true ) @PathVariable("data_bundle_id") String dataBundleId,
    ...
    public ResponseEntity<Ga4ghUpdateDataObjectResponse> updateDataObject(@ApiParam(value = "",required=true ) @PathVariable("data_object_id") String dataObjectId,
