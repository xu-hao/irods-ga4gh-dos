...
public class ListObjectsRequest {
	...
	public ListObjectsRequest alias(String alias) {
		this.alias = alias;
		return this;
	}
	...
	public ListObjectsRequest url(String url) {
		this.url = url;
		return this;
	}
	...
	public ListObjectsRequest checksum(String checksum) {
	...
	public ListObjectsRequest checksumType(String checksumType) {
	...
	public ListObjectsRequest pageSize(Integer pageSize) {
	...
	public ListObjectsRequest pageToken(String pageToken) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.alias, listObjectsRequest.alias) && Objects.equals(this.url, listObjectsRequest.url)
				&& Objects.equals(this.checksum, listObjectsRequest.checksum)
				&& Objects.equals(this.checksumType, listObjectsRequest.checksumType)
				&& Objects.equals(this.pageSize, listObjectsRequest.pageSize)
				&& Objects.equals(this.pageToken, listObjectsRequest.pageToken);
	}
